...
async function ytMp3(url) {
  ...
  try {
       ...
       let baseUrl = 'https://ycdn.savetube.su/info?url='
       ...
       let res2 = await axios.get('https://ycdn.savetube.su/download/audio/128/' + key)
       ...
       let result = {
             ...
             data: {
               ...
               mp3: res2.data.data.downloadUrl
